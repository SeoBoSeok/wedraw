...
<section id="bo_w">
    ...
    <!-- 수강정원 등록부분 추가 : start -->
    <div class="write_div"> <!-- 그누보드에서 wr_1 ~ wr_10 까지 추가 슬롯을 쓸수있게 해줌. -->
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="수강정원">
    </div>
    <!-- 수강정원 등록부분 추가 : end -->
